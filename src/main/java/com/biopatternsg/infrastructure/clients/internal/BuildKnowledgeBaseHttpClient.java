...
@RegisterRestClient(configKey = "build-knowledge-base-api")
public interface BuildKnowledgeBaseHttpClient {

    @POST
    @Path("/generate-kb")
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    GenerateKbResponse generateKb(PubTatorDocumentRequest document);
}
